        ...
        <section>
            {
                ...
                data.map((comment)=> {
                    <article>
                        <header><b>{comment.name}</b> commented on <time>{comment.date}</time></header>
                    </article>
                })
            }
        </section>
...
export function CommentForm() {
    ...
    <form className="flex flex-col">
        ...
        <div className="w-full mb-5"> 
            ...
            <textarea class="resize rounded-md w-full border p-2 border-gray-600 focus:border-blue-600 focus:outline-none focus:ring-1" placeholder="Enter your comment"></textarea>
        </div>
